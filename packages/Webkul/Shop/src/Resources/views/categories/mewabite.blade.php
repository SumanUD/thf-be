...
<body class="thf-dark-theme">
    ...
    <section class="content">
        ...
        <v-mewabite-products></v-mewabite-products>
    </section>
    ...
    <script type="module">
        app.component('v-mewabite-products', {
            template: '#v-mewabite-products-template',
            data() {
                return {
                    products: []
                }
            ...
            methods: {
                getProducts() {
                    this.$axios.get("{{ route('shop.api.products.index', ['category_id' => 5]) }}")
                        .then(response => {
