...
<body class="thf-dark-theme">
    ...
    <section class="content">
        ...
        <v-baklava-products></v-baklava-products>
    </section>
    
    @include('shop::partials.thf-footer')

    @pushOnce('scripts')
    <script type="text/x-template" id="v-baklava-products-template">
    ...
    <script type="module">
        app.component('v-baklava-products', {
            template: '#v-baklava-products-template',
            data() {
                return {
                    products: []
                }
            ...
            methods: {
                getProducts() {
                    this.$axios.get("{{ route('shop.api.products.index', ['category_id' => 2]) }}")
                        .then(response => {
